                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            ...
                            <div class="faq-heading"  id="FaqTitle1">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq1">Our Campus  launches new software channel</a>
                                </h4>
                            </div>
                            <div id="faq1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="FaqTitle1">
                                <div class="faq-body">We began our operations a few decades ago and have grown due to excellent relationships with our clients. We started out small, with just a few people and a small office, but today we have offices in multiple countries with hundreds of people working inside them. We started out small, with just a few people.</div>
                            </div>
                            <!--/ End Single Faq -->
                        </div>
                        <div class="panel panel-default active">
                            ...
                            <div class="faq-heading" id="FaqTitle2">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq2">Simple and elegant template with tons of features.</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="faq-heading"  id="FaqTitle3">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq3">Our Campus  launches new software channel</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="faq-heading"  id="FaqTitle4">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq4">Simple and elegant template with tons of features.</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="faq-heading"  id="FaqTitle5">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq5">Our Campus  launches new software channel</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="faq-heading"  id="FaqTitle6">
                                <h4 class="faq-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#faq6">Simple and elegant template with tons of features.</a>
                                </h4>
                            </div>
