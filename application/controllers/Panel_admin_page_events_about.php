...
class Panel_admin_page_events_about extends MY_Controller{
...
//      adminin icindeki papkanin adi
        $this->view_folder = "event_about";

//      tablemizin adi
        $this->table_name = "event_about";
...
//      tablemizin fieldlerinin array icinde siralanmasi BU DEYISILMIR!
        ...
        $this->label_name_and_input_name = array(
            ...
            "Haqqımizda Baçlıqı Az" => "(group2)name_az",
            "Haqqımizda Baçlıqı En" => "(group2)name_en",
            "Haqqımizda Baçlıqı Ru" => "(group2)name_ru",
...
//      tabledeki melumatlarin update olunduqu link
        $this->update_link                    = base_url("Panel_admin_page_events_about/update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      ajaxnan melumatlarin modalin icine getirilmesi
        $this->link_for_update_modal          = base_url("Panel_admin_page_events_about/get_data_for_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      proseslerden her hansi biri ugurla basa catdiqda hansi linke atsin
        $this->success_link                   = base_url("Panel_admin_page_events_about/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      proseslerden her hansi biri ugurla basa catmadiqda hansi linke atsin
        $this->error_link                     = base_url("Panel_admin_page_events_about/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      data tablenin icine melumatlarin ajaxnan getirilmesi ucun lazim olan link
        $this->get_data_link                  = base_url("Panel_admin_page_events_about/get_data");
    }
